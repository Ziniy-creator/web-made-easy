...
let createResultString = (key, displayedNum, state) => {
...
let updateCalculatorState = (key, calculator, calculatedValue, displayedNum) => {
  let keyType = getKeyType(key)
  let {
    firstValue,
    operator,
...
let updateVisualState = (key, calculator) => {
  let keyType = getKeyType(key)
...
keys.addEventListener('click', e => {
  ...
  let resultString = createResultString(key, displayedNum, calculator.dataset)
